...
const inspirationCards = [
  { label: 'Johannesburg', sublabel: 'Local favourite', img: 'https://images.unsplash.com/photo-1577948000111-9c970dfe3743?w=400' },
  { label: 'Cape Town',    sublabel: 'Top destination', img: 'https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=400' },
...
const getawayListings = {
  Beach:       ['Cape Town', 'Bali', 'Malibu', 'Phuket', 'Mykonos', 'Zanzibar', 'Tulum', 'Gold Coast'],
  Mountains:   ['Swiss Alps', 'Aspen', 'Banff', 'Queenstown', 'Zermatt', 'Patagonia', 'Chamonix', 'Whistler'],
  City:        ['Johannesburg', 'Cape Town', 'New York', 'Paris', 'Tokyo', 'London', 'Dubai', 'Singapore'],
  Countryside: ['Tuscany', 'Cotswolds', 'Provence', 'Napa Valley', 'Kyoto', 'Kerala', 'Highlands', 'Loire Valley'],
  Islands:     ['Bali', 'Maldives', 'Santorini', 'Seychelles', 'Bora Bora', 'Hawaii', 'Capri', 'Palawan'],
};
